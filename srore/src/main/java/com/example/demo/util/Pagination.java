...
public class Pagination {
	...
	private int beginPage;				// 페이지 내비게이션에 표시할 시작 페이지 번호
	...
	/**
	 * 현재 페이지번호와 총 데이터 갯수를 전달받아서 객체를 초기화하고, 페이징 처리에 필요한 값을 계산한다.
	 * @param page 현재 페이지번호
	...
	/**
	 * 현재 페이지번호와 총 데이터갯수, 한 화면에 표시할 데이터 갯수를 전달받아서 객체를 초기화하고, 페이징처리에 필요한 값을 계산한다.
	 * @param page 현재 페이지 번호
	 * @param totalRows 총 데이터 갯수
	 * @param rowsPerPage 한 화면에 표시할 데이터 겟수
	 */
